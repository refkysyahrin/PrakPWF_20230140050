            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-200">
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Add Product</h2>
                            <p class="text-sm text-gray-500 mt-0.5">Fill in the details to add a new product</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('product.store') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <select id="category_id" name="category_id"
                                    ...
                                    {{ $errors->has('category_id') ? 'border-red-400 bg-red-50' : 'border-gray-300 bg-white' }}
                                    focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition">
